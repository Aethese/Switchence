...
# Supported OS
I currently only support **Windows** for this app. It currently doesn't work for Linux or Mac but I have plans on making it work for version 2.0.0 and possibly a legacy update.
